...
@overload
def curry(pn: Literal[10], fn: Callable[Concatenate[A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, P], R], /) -> CurriedFixed10[A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R]: ...

@overload
def curry(pn: Literal[9], fn: Callable[Concatenate[A1, A2, A3, A4, A5, A6, A7, A8, A9, P], R], /) -> CurriedFixed9[A1, A2, A3, A4, A5, A6, A7, A8, A9, R]: ...

@overload
def curry(pn: Literal[8], fn: Callable[Concatenate[A1, A2, A3, A4, A5, A6, A7, A8, P], R], /) -> CurriedFixed8[A1, A2, A3, A4, A5, A6, A7, A8, R]: ...

@overload
def curry(pn: Literal[7], fn: Callable[Concatenate[A1, A2, A3, A4, A5, A6, A7, P], R], /) -> CurriedFixed7[A1, A2, A3, A4, A5, A6, A7, R]: ...

@overload
def curry(pn: Literal[6], fn: Callable[Concatenate[A1, A2, A3, A4, A5, A6, P], R], /) -> CurriedFixed6[A1, A2, A3, A4, A5, A6, R]: ...

@overload
def curry(pn: Literal[5], fn: Callable[Concatenate[A1, A2, A3, A4, A5, P], R], /) -> CurriedFixed5[A1, A2, A3, A4, A5, R]: ...

@overload
def curry(pn: Literal[4], fn: Callable[Concatenate[A1, A2, A3, A4, P], R], /) -> CurriedFixed4[A1, A2, A3, A4, R]: ...

@overload
def curry(pn: Literal[3], fn: Callable[Concatenate[A1, A2, A3, P], R], /) -> CurriedFixed3[A1, A2, A3, R]: ...

@overload
def curry(pn: Literal[2], fn: Callable[Concatenate[A1, A2, P], R], /) -> CurriedFixed2[A1, A2, R]: ...

@overload
def curry(pn: Literal[1], fn: Callable[Concatenate[A1, P], R], /) -> CurriedFixed1[A1, R]: ...
