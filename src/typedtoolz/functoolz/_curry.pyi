...
@overload
def curry(pn: Literal[9], /) -> _CurryFixed9Maker: ...

@overload
def curry(pn: Literal[8], /) -> _CurryFixed8Maker: ...

@overload
def curry(pn: Literal[7], /) -> _CurryFixed7Maker: ...

@overload
def curry(pn: Literal[6], /) -> _CurryFixed6Maker: ...

@overload
def curry(pn: Literal[5], /) -> _CurryFixed5Maker: ...

@overload
def curry(pn: Literal[4], /) -> _CurryFixed4Maker: ...

@overload
def curry(pn: Literal[3], /) -> _CurryFixed3Maker: ...

@overload
def curry(pn: Literal[2], /) -> _CurryFixed2Maker: ...

@overload
def curry(pn: Literal[1], /) -> _CurryFixed1Maker: ...
